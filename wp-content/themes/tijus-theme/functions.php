...
function tijus_custom_login_ui() {
    $logo_url = tijus_get_logo_url();
    echo '<style type="text/css">
        body.login { background-color: #f4f6f9; font-family: "Montserrat", sans-serif; }
        .login h1 a {
        ...
        .login .button-primary:hover {
            background-color: #267544 !important;
            transform: translateY(-1px);
        }
        .login #login_error, .login .message {
            border-radius: 8px;
            border-left-color: #309255;
        }
        .login #login_error {
